  ...
  >
    ...
    >
      ...
      <nuxt-link to="/signUp.vue">
        <!--  before:content-[url(./assets/mini-icons/User.svg)] -->
    ...
    <div
      class="lg:hidden h-[70vh] grid grid-cols-1 absolute right-5 w-[80vw] text-base top-5 px-8 py-12 grid-rows-3 bg-primary rounded-lg"
    >
